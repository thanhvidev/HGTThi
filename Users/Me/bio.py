...
class BioModal(discord.ui.Modal):
    ...
    async def update_profile_embed(self, interaction):
        ...
        view = BioView(user_id, marry_status)
...
class RelationshipSelect(discord.ui.Select):
    ...
    async def update_profile_embed(self, interaction):
        """Sử dụng lại phương thức từ BioModal"""
        modal = BioModal()
...
class Bio(commands.Cog):
    ...
    @commands.command(description="Xem profile cá nhân")
    ...
    @bio.error
    async def bio_error(self, ctx, error):
