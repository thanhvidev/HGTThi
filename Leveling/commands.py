...
class LevelingCommands(commands.Cog):
    ...
    @commands.hybrid_command(name="profile", description="Xem profile level của bạn hoặc người khác")
...
**Thành Tựu:** {len(stats['achievements'])}/{ len(config.ACHIEVEMENTS)}""",
    ...
    @commands.hybrid_command(name="leaderboard", aliases=["lb", "top"], description="Xem bảng xếp hạng")
    ...
    @commands.hybrid_command(name="achievements", aliases=["achieve"], description="Xem thành tựu của bạn")
